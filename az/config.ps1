...
$Env:cosmos_sql_rg="chjoakimsl"               # sl = Cosmos-Synapse-Link
$Env:cosmos_sql_acct_name="chjoakimslcosmos"
...
#
$Env:cosmos_mongo_region="eastus"
$Env:cosmos_mongo_rg="chjoakimsl"               # sl = Cosmos-Synapse-Link
$Env:cosmos_mongo_acct_name="chjoakimslcosmosmongo"
$Env:cosmos_mongo_acct_consistency="Session"    # {BoundedStaleness, ConsistentPrefix, Eventual, Session, Strong}
$Env:cosmos_mongo_acct_kind="GlobalDocumentDB"  # {GlobalDocumentDB, MongoDB, Parse}
$Env:cosmos_mongo_dbname="demo"
$Env:cosmos_mongo_cname="travel"
$Env:cosmos_mongo_pk_path="/pk"
$Env:cosmos_mongo_db_throughput="5000"
$Env:cosmos_mongo_sl_ttl="220903200"            # 7-years, in seconds (60 * 60 * 24 * 365.25 * 7)
#
$Env:synapse_region="eastus"
$Env:synapse_rg="chjoakimsl"                  # sl = Cosmos-Synapse-Link
$Env:synapse_name="chjoakimslsynapse"
