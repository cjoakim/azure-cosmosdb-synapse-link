...
print('df written to blob storage, with coalesce')
...
blob_account_name = 'cjoakimstorage' # replace with your blob name
blob_container_name = 'synapse' # replace with your container name
blob_relative_path = 'usa-states-text.csv' # replace with your relative folder path
linked_service_name = 'cjoakimstorageAzureBlobStorage'
...
df2.rdd.saveAsTextFile(wasb_path)
print('df written to blob storage, as text')

# Row(id='50', code='WV', name='West Virginia')
# Row(id='51', code='WY', name='Wyoming')
